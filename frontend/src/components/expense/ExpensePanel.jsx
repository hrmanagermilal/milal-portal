...
export default function ExpensePanel({ initialExpenseId = null }) {
  ...
  const status = (value) => ({ reviewing: t("expenseInReview"), approved: t("expenseFirstApproved"), paid: t("expensePaid"), rejected: t("expenseReject"), cancelled: t("expenseCancelled") })[value];
